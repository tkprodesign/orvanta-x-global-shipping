...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;">Your OrvantaX Global Shipping verification code is inside.</div>
...
<tr><td style="background-color:#f8fafc;border-top:1px solid #e5e7eb;padding:16px 24px;"><p style="margin:0;font-size:11px;line-height:1.5;color:#6b7280;">© ' . $currentYear . ' OrvantaX Global Shipping. Please do not reply to this email.</p></td></tr>
</table>
</td>
</tr>
</table>
